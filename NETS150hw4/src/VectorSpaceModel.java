 ...
 * the tf-idf vectors for each document.
 * 
 * @author swapneel
 *
 */
public class VectorSpaceModel {
    ...
    /**
     * The tf-idf weight vectors. The hashmap maps a document to another hashmap.
    ...
    /**
     * The constructor. It will take a corpus of documents. Using the corpus, it
     * will generate tf-idf vectors for each document.
     * 
    ...
    /**
     * This will return the cosine similarity of two documents. This will range from
